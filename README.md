...
**総合的な示唆**  
グレーゾーン（年齢、婚姻状況）を除いて図を見ると、収入を上げる要因はコントロール内（学歴・職業・労働時間）に限られる一方、収入を下げる要因にはコントロール外（人種・性別・出身国）とコントロール内の両方が含まれる。これは、マイノリティ属性を持つ人々はそもそも不利な条件で人生のスタート地点に立つことを示唆している。また、以下の点には留意が必要である。
