...
- 自営（法人）は民間企業より高収入傾向、自営（無法人）は低収入傾向
...
*図7: 各変数の高収入オッズへの影響（%）。オレンジがコントロール外、青がコントロール内、紫がグレーゾーン。*

オッズ比・特徴量重要度の結果を踏まえると、以下のことが言える。

**コントロール外の要因について**  
年齢（50〜59: +16%、40〜49: +15%）や性別（Male: +5%）は収入に正の影響を持つ。一方、出身国（South: -11%、Vietnam・China: -10%）や人種（Amer-Indian-Eskimo: -5%）は負の影響を示した。

**グレーゾーンの要因について**
婚姻状況（Married-civ-spouse: +13%）は選択の側面を持つ一方、文化・経済状況にも依存するためグレーゾーンに分類した。

**コントロール内の要因について**  
学歴・職業・労働時間はいずれも収入と強い関連を示し、特に学歴（High: +16%、Low: -7%）と職業（Exec-managerial: +13%）の影響は大きい。

**総合的な示唆**  
図全体を見ると、収入を下げる要因はコントロール外（出身国・人種）が中心である一方、収入を上げる要因にはコントロール内（学歴・職業・労働時間）が多く含まれるという傾向が見られる。
ただし、年齢（コントロール外）も+15〜16%と大きな正の影響を持つ。また、以下の点には留意が必要である。

- 今回コントロール内とした学歴や職業の選択それ自体が、人種・性別・家庭環境などコントロール外の要因に影響されている可能性がある
